...
function Hero() {
  // In JavaScript, we don't need the type annotation
      ...
      <section className="relative z-10 lg:grid lg:h-auto min-h-screen">
        <div className="mx-auto w-full max-w-screen-xl px-4 py-16 sm:px-6 sm:py-24 lg:px-8 lg:py-32">
          ...
          <div className="mx-auto max-w-prose text-center mb-20">
            ...
            <p className="mt-4 text-base text-pretty text-secondary sm:text-lg/relaxed">
            ...
            <div className="mt-8 flex justify-center gap-4 sm:mt-10">
              <a
                className="inline-block rounded-lg border bg-primary px-6 py-3 font-medium text-white shadow-sm transition-colors hover:bg-secondary hover:border-secondary"
                href="/dashboard"
              >
                Get Started
              </a>
              ...
              <button
                ...
                className="inline-block rounded-lg border border-gray-200 px-6 py-3 font-medium text-gray-700 shadow-sm transition-colors hover:bg-gray-100 hover:text-gray-900"
              >
                Learn More
              </button>
            </div>
          ...
          <div ref={howItWorksRef} className="mt-96 lg:mt-80">
            <h2 className="text-4xl font-bold text-center text-primary mb-16">How It Works</h2>
            
            <div className=" gap-8 relative flex items-center justify-center">
              {/* Card 1 */}
              ...
              {/* Animated Arrow 1 */}
              <div className="hidden md:flex items-center justify-center animate-bounce-x">
              ...
              <div className="bg-white p-8 rounded-xl shadow-lg border border-gray-100 hover:shadow-xl transition-shadow">
                <div className="flex flex-col items-center text-center">
                  ...
                  <h3 className="text-xl font-semibold mb-3">Customize Your Form</h3>
                  <p className="text-gray-600">
              ...
              <div className="bg-white p-8 rounded-xl shadow-lg border border-gray-100 hover:shadow-xl transition-shadow">
                <div className="flex flex-col items-center text-center">
                  ...
                  <h3 className="text-xl font-semibold mb-3">Share & Collect Data</h3>
                  <p className="text-gray-600">
